...
def main():
    ...
    # success = serial._send_struct(config_id, config_id, channel_type, channel_id, input_range, alarm_type, alarm_state, alarm_occurring, resistive_temp, current_source, sensor_type, 500, 125)
    # print(success)
